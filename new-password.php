      ...
      <div class="box">
        <div class="inner-box">
          <div class="forms-wrap">
            <form action="new-password.php" method="POST" autocomplete="off" class="sign-in-form">
              <div class="logo">
              ...
              <div class="heading">
                ...
                <?php 
                    if(isset($_SESSION['info'])){
                        ?>
                        <div class="alert alert-success text-center sucol">
              ...
              <div class="actual-form">
                ...
                <input type="submit" name="change-password" value="Change" class="sign-btn" />
