      ...
      <div class="box">
        <div class="inner-box">
          <div class="forms-wrap">
            <form action="user-otp.php" method="POST" autocomplete="off" class="sign-in-form">
              <div class="logo">
              ...
              <div class="heading">
                ...
                <?php 
                    if(isset($_SESSION['info'])){
                        ?>
                        <div class="alert alert-success text-center sucol" style="padding: 0.4rem 0.4rem">
              ...
              <div class="actual-form">
                <div class="input-wrap">
                  ...
                  type="text" name="otp"
                    class="input-field"
                    name="otp" placeholder="Enter OTP code"
                    autocomplete="off"
                ...
                <input type="submit" name="check-reset-otp" value="Submit" class="sign-btn" />
