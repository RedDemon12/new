...
?>                            </div>
              ...
              <div class="row">
                <div class="col-md-12">
                  ...
                  <ul class="nav nav-pills flex-column flex-md-row mb-3">
                    <li class="nav-item">
                      <a class="nav-link active" href="javascript:void(0);"><i class="bx bx-user me-1"></i>Review Account</a>
                    </li>
                  </ul>
                  <div class="card mb-4">
 ...
 {
 ?>                 
                    <h5 class="card-header">Change Account Type</h5>
                    ...
                    <div class="card-body">
                      <div class="d-flex align-items-start align-items-sm-center gap-4">
                        ...
                        <label for="basic-default-name" class="col-sm-12 col-form-label">Selete your account type, currently it's public
</label>
                        <div class="col-sm-4">
                        <select name="complaintype" id="defaultSelect" class="form-select" required="">
                        <option value=" Complaint">Public</option>
                        <option value="General Query">Private</option>
                        </select> 
                        </div>                          </div>
                        </div>
                      </div>
              ...
              <div class="container-xxl d-flex flex-wrap justify-content-between py-2 flex-md-row flex-column">
               ...
               When account is <b>private only your followers can interact with with your profile.</b> <br>
               Others would have to follow you first to interact. This is the <b>recommended</b> option as only people you know would interact with your profile.<br>
And when account is public <b>anyone can see your profile and interact with your profile.</b>
<br><br>
...
<div class="card mb-4">
 ...
 <?php $query=mysqli_query($con,"select * from block where block_by='".$_SESSION['id']."'");
 while($row=mysqli_fetch_array($query)) 
 {
 ?>           <?php }?>      
                    <h5 class="card-header">BLOCKED USERS</h5>
                    ...
                    <div class='d-flex align-items-center justify-content-center'>
                        ...
                        <p class="text-muted mb-0 abd style='text-align: center;'">No Blocked Users</p>
